...
export type Class<T, Q = any> = Function & { prototype: T } & { new (query: Q, parent?: Class<IBaseQueryBuilder<any, any>>, restrictedBuilders?: string[]): T };
...
export class BaseColumnBuilder<T extends ParcelQLExpression = ParcelQLExpression,R = Knex.Raw> extends
    BaseQueryBuilder<T,R> {
        ...
        constructor(query: T, parent?: Class<IBaseQueryBuilder<T,R>>, restrictedBuilders?: string[]) {
            super(query);
            this.parent = parent;
