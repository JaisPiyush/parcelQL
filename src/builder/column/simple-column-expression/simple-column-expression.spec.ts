...
//         // Undefined column
//         expect(() => {
//             new ParcelQLSimpleColumnExpressionBuilder({} as any);
//         }).to.throw(`column value "undefined" is not valid`);
//         expect(() => {
//             new ParcelQLSimpleColumnExpressionBuilder({ column: null } as any);
//         }).to.throw(`column value "null" is not valid`);
//         expect(() => {
//             new ParcelQLSimpleColumnExpressionBuilder({ column: '' });
...
//         expect(() => {
//             new ParcelQLSimpleColumnExpressionBuilder({
//                 column: 'a',
//                 type: true as any
//             });
